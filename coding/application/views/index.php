...
<head>
  ...
  <!-- Font Awesome CSS -->
  <link rel="stylesheet" href="<?php echo $root ?>css/font-awesome.min.css" type="text/css" media="screen">

  <!-- Slicknav -->
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/slicknav.css" media="screen">

  <!-- Margo CSS Styles  -->
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/style.css" media="screen">

  <!-- Responsive CSS Styles  -->
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/responsive.css" media="screen">

  <!-- Css3 Transitions Styles  -->
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/animate.css" media="screen">

  <!-- Color CSS Styles  -->
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/colors/red.css" title="red" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/colors/jade.css" title="jade" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/colors/green.css" title="green" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/colors/blue.css" title="blue" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/colors/beige.css" title="beige" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/colors/cyan.css" title="cyan" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/colors/orange.css" title="orange" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/colors/peach.css" title="peach" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/colors/pink.css" title="pink" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/colors/purple.css" title="purple" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/colors/sky-blue.css" title="sky-blue" media="screen" />
  <link rel="stylesheet" type="text/css" href="<?php echo $root ?>css/colors/yellow.css" title="yellow" media="screen" />

  <!-- Margo JS  -->
  <script type="text/javascript" src="<?php echo $root ?>js/jquery-2.1.4.min.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/jquery.migrate.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/modernizrr.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>asset/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/jquery.fitvids.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/owl.carousel.min.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/nivo-lightbox.min.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/jquery.isotope.min.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/jquery.appear.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/count-to.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/jquery.textillate.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/jquery.lettering.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/jquery.easypiechart.min.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/jquery.nicescroll.min.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/jquery.parallax.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/mediaelement-and-player.js"></script>
  <script type="text/javascript" src="<?php echo $root ?>js/jquery.slicknav.js"></script>
          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <ul class="contact-details">
                <li><a href="#"><i class="fa fa-map-marker"></i> House-54/A, Lahore, Pakistan </a>
                </li>
                <li><a href="#"><i class="fa fa-envelope-o"></i> info@therightsol.com</a>
                </li>
                <li><a href="#"><i class="fa fa-phone"></i> +92 333 123 4567</a>
                </li>
              </ul>
              <!-- End Contact Info -->
            </div>

            ...
            <div class="col-md-12"> 
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group <?php if($_POST){ if (form_error('comment') != '') { ?> has-error <?php } } ?>" >
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" rows="4" name="comment" style="resize:none"><?php if($_POST){ echo $_POST['comment']; } ?></textarea>
                ...
                <?php }else{ ?>
                    <div class="alert alert-success col-sm-8 col-md-offset-2" style="margin-top: 8%; margin-bottom: 10%;">
                        ...
                        <a href="<?php echo base_url(); ?>admin_panel/add_kafeel" style="color:#2A7FFF" >Click here to Go Back</a>
                    </div>
                <?php }
                 }else{ ?>
